# -*- coding: utf-8 -*-
"""
Created on Fri Apr 21 17:40:52 2023
...
bicycles.dropna(inplace=True)

# Making our training and test sets with the COVID-19 dummy
xbicycle_dummy_yes = bicycles[['temp', 'rain', 'wind', 'bikes +1 week', 'bikes +1 year', 'bikes +1 week', 'workday', 'covid']]
...
print('Linear Regression Mean Squared Error, testing set:', lm_MSE) # = 1819.23
print('Linear Regression R-squared:', lm_R2) # = 0.54

# Predicting the mean value
lm_mean_pred = np.mean(lm_pred_test1)
print("Linear Regression mean predicted value:", lm_mean_pred) # = 58.53
...
print('OLS Mean Squared Error, testing set:', ols_MSE) # = 1819.23
print('OLS R-squared:', ols_R2) # = 0.54

# Predicting the mean value
ols_mean_pred = np.mean(ols_pred_test1)
print("OLS mean predicted value:", ols_mean_pred) # = 58.53
...
print('Lasso Mean Squared Error, testing set:', lasso_MSE) # = 1819.23
print('Lasso R-squared:', lasso_R2) # = 0.54

# Predicting the mean value
lasso_mean_pred = np.mean(lasso_pred_test1)
print("Exponentiated Lasso mean predicted value:", lasso_mean_pred) # = 58.53
...
print('Ridge Mean Squared Error, testing set:', ridge_MSE) # = 1819.23 
print('Ridge R-squared:', ridge_R2) # = 0.54

# Predicting the mean value
ridge_mean_pred = np.mean(ridge_pred_test1)
print("Ridge mean predicted value:", ridge_mean_pred) # = 58.52
...
print('Random Forests Mean squared error, testing set:', rf_MSE) # = 1075.47
print('Random Forest R-squared:', rf_R2) # = 0.73

# Predicting the mean value
rf_mean_pred = np.mean(rf_pred_test1)
print("Random Forests mean predicted value:", rf_mean_pred) # = 58.48

rf.feature_importances_ # = 0.06138176, 0.02317942, 0.02639204, 0.31623461, 0.09741019, 0.36395093, 0.08113044, 0.0303206 
...
knn = KNeighborsRegressor(n_neighbors=20).fit(xbicycle_train_dummy_yes, ybicycle_train_dummy_yes)
...
print('KNN Mean squared error, testing set:', knn_MSE) # = 1611.93
print('KNN R-squared:', knn_R2) # 0.59

# Predicting the mean value
knn_mean_pred = np.mean(knn_pred_test1)
print("KNN mean predicted value:", knn_mean_pred) # = 58.34
...
xbicycle_sq = bicycles[['temp', 'rain', 'wind', 'bikes +1 week', 'bikes +1 year', 'bikes +1 week', 'workday', 'covid', 'tempsq', 'rainsq']]
...
xbicycle_cub = bicycles[['temp', 'rain', 'wind', 'bikes +1 week', 'bikes +1 year', 'bikes +1 week', 'workday', 'covid', 'tempsq', 'rainsq', 'tempcub', 'raincub']]
...
xbicycle_exp = bicycles[['temp', 'rain', 'wind', 'bikes +1 week', 'bikes +1 year', 'bikes +1 week', 'workday', 'covid', 'tempsq', 'rainsq', 'tempcub', 'raincub', 'tempexp', 'rainexp']]
...
# 0.01549677, 0.00587334, 0.02550429, 0.3248552 , 0.09721013,
 #      0.35443829, 0.08100558, 0.03010241, 0.0165082 , 0.00543631,
 #      0.0160239 , 0.0058534 , 0.0155196 , 0.00617256
...
print('Squared Linear Regression Mean Squared Error, testing set:', sq_lm_MSE) # = 1801.23
print('Squared Linear Regression R-squared:', sq_lm_R2) # = 0.54

# Predicting the mean value
sq_lm_mean_pred = np.mean(sq_lm_pred_test1)
print("Squared Linear Regression mean predicted value:", sq_lm_mean_pred) # = 58.53
...
print('Squared OLS Mean Squared Error, testing set:', sq_ols_MSE) # = 1801.23
print('Squared OLS R-squared:', sq_ols_R2) # = 0.54

# Predicting the mean value
sq_ols_mean_pred = np.mean(sq_ols_pred_test1)
print("Squared OLS mean predicted value:", sq_ols_mean_pred) # = 58.53
...
print('Squared Lasso Mean Squared Error, testing set:', sq_lasso_MSE) # = 1801.23
print('Squared Lasso R-squared:', sq_lasso_R2) # = 0.54


# Predicting the mean value
sq_lasso_mean_pred = np.mean(sq_lasso_pred_test1)
print("Squared Lasso mean predicted value:", sq_lasso_mean_pred) # = 58.53
...
print('Squared Ridge Mean Squared Error, testing set:', sq_ridge_MSE) # = 1801.23
print('Squared Ridge R-squared:', sq_ridge_R2) # = 0.54

# Predicting the mean value
sq_ridge_mean_pred = np.mean(sq_ridge_pred_test1)
print("Squared Ridge mean predicted value:", sq_ridge_mean_pred) # = 58.53
...
print('Squared Random Forests Mean squared error, testing set:', sq_rf_MSE) # = 1.071.85
print('Squared Random Forest R-squared:', sq_rf_R2) # = 0.73

# Predicting the mean value
sq_rf_mean_pred = np.mean(sq_rf_pred_test1)
print("Squared Random Forests mean predicted value:", sq_rf_mean_pred) # = 58.48
...
sq_knn = KNeighborsRegressor(n_neighbors=20).fit(xbicycle_train_sq, ybicycle_train_dummy_yes)
...
print('Squared KNN Mean squared error, testing set:', sq_knn_MSE) # 1501.25
print('Squared KNN R-squared:', sq_knn_R2) # 0.62

# Predicting the mean value
sq_knn_mean_pred = np.mean(sq_knn_pred_test1)
print("Squared KNN mean predicted value:", sq_knn_mean_pred) # = 58.58
...
print('Cubed Linear Regression Mean Squared Error, testing set:', cub_lm_MSE) # = 1797.44
print('Cubed Linear Regression R-squared:', cub_lm_R2) # = 0.54


# Predicting the mean value
cub_lm_mean_pred = np.mean(cub_lm_pred_test1)
print("Cubed Linear Regression mean predicted value:", cub_lm_mean_pred) # = 58.53
...
print('Cubed OLS Mean Squared Error, testing set:', cub_ols_MSE) # = 1797.44
print('Cubed OLS Regression R-squared:', cub_ols_R2) # = 0.54

# Predicting the mean value
cub_ols_mean_pred = np.mean(cub_ols_pred_test1)
print("Cubed OLS mean predicted value:", cub_ols_mean_pred) # = 58.53
...
print('Cubed Lasso Mean Squared Error, testing set:', cub_lasso_MSE) # = 1797.44
print('Cubed Lasso Regression R-squared:', cub_lasso_R2) # = 0.54


# Predicting the mean value
cub_lasso_mean_pred = np.mean(cub_lasso_pred_test1)
print("Cubed Lasso mean predicted value:", cub_lasso_mean_pred) # = 58.54
...
print('Cubed Ridge Mean Squared Error, testing set:', cub_ridge_MSE) # = 1797.44
print('Cubed Ridge Regression R-squared:', cub_ridge_R2) # = 0.54

# Predicting the mean value
cub_ridge_mean_pred = np.mean(cub_ridge_pred_test1)
print("Cubed Ridge mean predicted value:", cub_ridge_mean_pred) # = 58.53
...
print('Cubed Random Forests Mean squared error, testing set:', cub_rf_MSE) # = 1071.68
print('Cubed Random Forest R-squared:', cub_rf_R2) # = 0.73

# Predicting the mean value
cub_rf_mean_pred = np.mean(cub_rf_pred_test1)
print("Cubed Random Forests mean predicted value:", cub_rf_mean_pred) # = 58.48
...
cub_knn = KNeighborsRegressor(n_neighbors=20).fit(xbicycle_train_cub, ybicycle_train_dummy_yes)
...
print('Cubed KNN Mean squared error, testing set:', cub_knn_MSE) # = 1396.25
print('Cubed KNN R-squared:', cub_knn_R2) # = 0.64

# Predicting the mean value
cub_knn_mean_pred = np.mean(cub_knn_pred_test1)
print("Cubed KNN mean predicted value:", cub_knn_mean_pred) # = 58.15
...
print('Exponentiated Linear Regression Mean Squared Error, testing set:', exp_lm_MSE) # = 1796.02
print('Exponentiated Linear Regression R-squared:', exp_lm_R2) # = 0.54

# Predicting the mean value
exp_lm_mean_pred = np.mean(exp_lm_pred_test1)
print("Exponentiated Linear Regression mean predicted value:", exp_lm_mean_pred) # = 58.54
...
print('Exponentiated OLS Mean Squared Error, testing set:', exp_ols_MSE) # = 1796.02
print('Exponentiated OLS R-squared:', exp_ols_R2) # = 0.54

# Predicting the mean value
exp_ols_mean_pred = np.mean(exp_ols_pred_test1)
print("Exponentiated OLS mean predicted value:", exp_ols_mean_pred) # = 58.54


# Running our Lasso model for the squared, cubed, and exponential variables
expLasso_model = LassoCV(alphas=arange(0, 1, 0.01), cv=5, n_jobs=-1).fit(xbicycle_train_exp, ybicycle_train_dummy_yes)
...
print('Exponentiated Lasso Mean Squared Error, testing set:', exp_lasso_MSE) # = 1796.02
print('Exponentiated Lasso R-squared:', exp_lasso_R2) # = 0.54

# Predicting the mean value
exp_lasso_mean_pred = np.mean(exp_lasso_pred_test1)
print("Exponentiated Lasso mean predicted value:", exp_lasso_mean_pred) # = 58.54
...
print('Exponentiated Ridge Mean Squared Error, testing set:', exp_ridge_MSE) # = 1796.02
print('Exponentiated Ridge R-squared:', exp_ridge_R2) # = 0.54
...
print('Expoentiated Random Forests Mean squared error, testing set:', exp_rf_MSE) # = 1.071.57
print('Exponentiated Random Forest R-squared:', exp_rf_R2) # = 0.73

# Predicting the mean value
exp_rf_mean_pred = np.mean(exp_rf_pred_test1)
print("Exponentiated Random Forests mean predicted value:", exp_rf_mean_pred) # = 58.48

exp_rf.feature_importances_ # = 0.01549677, 0.00587334, 0.02550429, 0.3248552 , 0.09721013,
 #      0.35443829, 0.08100558, 0.03010241, 0.0165082 , 0.00543631,
 #      0.0160239 , 0.0058534 , 0.0155196 , 0.00617256
...
print('Exponentiated KNN Mean squared error, testing set:', exp_knn_MSE) # = 1194.49
print('Exponentiated KNN R-squared:', exp_knn_R2) # = 0.69

# Predicting the mean value
exp_knn_mean_pred = np.mean(exp_knn_pred_test1)
print("Exponentiated KNN mean predicted value:", exp_knn_mean_pred) # = 58.12
